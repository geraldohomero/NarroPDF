...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "pt": {
        ...
        "active_voices": "Vozes Ativas",
        "download": "Baixar",
        "delete": "Remover",
        "downloaded": "Baixado",
        "no_downloaded_voices": "Nenhuma voz do Piper baixada para este idioma. Por favor, baixe pelo menos uma nas Configurações.",
        "add_language": "Adicionar Idioma",
        "language_code": "Código do Idioma (ex: fr-FR)",
        "download_location": "Local de salvamento",
        "voices_visibility": "Visibilidade das Vozes",
        "piper_voices_mgmt": "Gerenciamento do Piper",
        "edge_voices_mgmt": "Gerenciamento do Edge TTS",
        "downloading_percent": "Baixando: {percent}%",
        "status_success": "Download concluído com sucesso!",
    },
    "en": {
        "app_name": "NarroPDF",
        "open_pdf": "Open PDF",
        ...
        "engine": "TTS Engine",
        "settings": "Settings",
        "active_voices": "Active Voices",
        "download": "Download",
        "delete": "Remove",
        "downloaded": "Downloaded",
        "no_downloaded_voices": "No Piper voice downloaded for this language. Please download at least one in Settings.",
        "add_language": "Add Language",
        "language_code": "Language Code (e.g., fr-FR)",
        "download_location": "Save location",
        "voices_visibility": "Voices Visibility",
        "piper_voices_mgmt": "Piper Management",
        "edge_voices_mgmt": "Edge TTS Management",
